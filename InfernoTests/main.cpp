...
void RunAdditionTests(Inferno::Device device) {
...

    {
        ...
        ExpectTensorEq("Addition grad a", a.Getgrad(), expected_a_grad, stats);
        ExpectTensorEq("Addition grad b", b.Getgrad(), expected_b_grad, stats);
    }

    {
        ...
        ExpectTensorEq("Addition grad a broadcast", a.Getgrad(), expected_a_grad, stats);
        ExpectTensorEq("Addition grad b broadcast", b.Getgrad(), expected_b_grad, stats);
    }

    {
        ...
        ExpectTensorEq("Addition grad a broadcast B", a.Getgrad(), expected_a_grad, stats);
        ExpectTensorEq("Addition grad b broadcast B", b.Getgrad(), expected_b_grad, stats);
    }
