...
namespace Inferno {
    ...
    void cuda_add(const AT* aptr,
        ...
        check_cuda(cudaMemcpy(d_a_strides, a_padded_strides.data(), out_rank * sizeof(size_t), cudaMemcpyHostToDevice), "cuda_add cudaMemcpy d_a_strides failed");
        check_cuda(cudaMemcpy(d_b_strides, b_padded_strides.data(), out_rank * sizeof(size_t), cudaMemcpyHostToDevice), "cuda_add cudaMemcpy d_b_strides failed");
