...
namespace Inferno {
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    //
    //  Function subtract_kernel_broadcast
    //
    //
    //
    //
    ...
    template<typename AT, typename BT, typename RT>
    void cuda_subtract(const AT* aptr,
        const BT* bptr,
        RT* outptr,
        ...
        if (out_rank > MAX_DIMS) {
            INFERNO_LOG_ERROR() << "cuda_subtract: out rank exceeds MAX_DIMS" << std::endl;
            exit(1);
        }
        ...
        check_cuda(cudaMemcpy(d_a_padded, a_padded_shape.data(), out_rank * sizeof(size_t), cudaMemcpyHostToDevice), "cuda_subtract cudaMemcpy d_a_padded failed");
        check_cuda(cudaMemcpy(d_b_padded, b_padded_shape.data(), out_rank * sizeof(size_t), cudaMemcpyHostToDevice), "cuda_subtract cudaMemcpy d_b_padded failed");
        ...
        check_cuda(cudaMemcpy(d_a_strides, a_padded_strides.data(), out_rank * sizeof(size_t), cudaMemcpyHostToDevice), "cuda_subtract cudaMemcpy d_a_strides failed");
        check_cuda(cudaMemcpy(d_b_strides, b_padded_strides.data(), out_rank * sizeof(size_t), cudaMemcpyHostToDevice), "cuda_subtract cudaMemcpy d_b_strides failed");
